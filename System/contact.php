...
<head>
	...
	<title>Job Buddy - Contact Us</title>
				...
				<div class="container">
					...
					<div id="navbar" class="navbar-nav-wrapper navbar-arrow">
						...
						<ul class="nav navbar-nav" id="responsive-menu">
							...
							<li>
								<a href="employers.php">Companys</a>
							</li>
				...
				<div class="container">
					...
					<div class="row">
						...
						<?php include 'constants/check_reply.php'; ?>
							...
							<form class="contact-form-wrapper" data-toggle="validator" action="app/sendcommunication.php" method="POST" autocomplete="off">
								...
								<div class="row">
									...
									<div class="col-sm-12">
										...
										<div class="form-group">
											...
											<textarea id="inputMessage" name="message" class="form-control" rows="8" data-minlength="10" data-error="Your message is required and must not less than 10 characters" required></textarea>
											<div class="help-block with-errors"></div>
										</div>
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> National Institute of Technology, <br/> Calicut, <br/>Kerala</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:dikshantbisht02@gmail.com">dikshantbisht02@gmail.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+919988841556">+919988841556</a>
								</li>
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-5 mt-30-xs">
										...
										<ul class="footer-menu clearfix">
											...
											<li><a href="employers.php">Companys</a></li>
