...
<head>
	...
	<title>Job Buddy - Posted Jobs</title>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						<li><span>My Posted Jobs</span></li>
					</ol>
								...
								<div class="admin-content-wrapper">
									...
									<?php
										...
										try 
										{
											...
											$stmt = $conn->prepare("SELECT * FROM tbl_jobs LIMIT $page1,5");
											$stmt->execute();
											...
											foreach($result as $row)
                                        {
										   ...
										   ?>
											...
											<a target="_blank" href="../Adminexplore-job.php?jobid=<?php echo $row['job_id']; ?>">
