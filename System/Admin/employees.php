								...
								<div class="admin-content-wrapper">
									...
									<?php
										...
										try 
										{
											...
											$stmt = $conn->prepare("SELECT * FROM tbl_users WHERE role = 'employee' ORDER BY first_name DESC LIMIT $page1,5");
											$stmt->execute();
											...
											foreach($result as $row)
											{
												...
												<div class="sub-category">
													<a onclick = "return confirm('Are you sure you want to delete this Employee ?')" href="app/drop-employee.php?id=<?php echo $row['email']; ?>">Delete Employee</a>
												</div>
												</div>
												<?php 
											}
